...
func LoadRestRoutes(r *mux.Router, sdk interfaces.Sdk, pub chan []byte, logger logInterface.Logger) {
	r.HandleFunc("/",
...
func postReceiveDataHandler(w http.ResponseWriter, r *http.Request, sdk interfaces.Sdk, pub chan []byte, logger logInterface.Logger) {
	if r.Body != nil {
